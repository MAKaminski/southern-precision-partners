...
const CONFIDENTIAL_KB: Record<string, string> = {
  ...
  // AUDIT-FOLLOWUP: waterfall/returns below still reflect the prior $400K/79%-profit-share
  // structure, not the new $280K GP equity figure — needs a full model rebuild, not a
  // find-and-replace. See ROADMAP.md.
